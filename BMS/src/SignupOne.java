...
public class SignupOne extends JFrame implements ActionListener {
    ...
    SignupOne(String formno) {
        ...
        random = Math.abs(ran.nextLong() % 9000L + 1000L); // Random form number

        JLabel formno2 = new JLabel("APPLICATION FORM NO. " + random);
        formno2.setFont(new Font("Raleway", Font.BOLD, 38));
        formno2.setBounds(140, 20, 600, 40);
        add(formno2);
        ...
        try {
            if (name.equals("")) {
                ...
                String query = "INSERT INTO signup (formno, name, father_name, dob, gender, email, marital_status, address, city, pincode, state) "
                        +
                        "VALUES ('" + formno + "', '" + name + "', '" + father_name + "', '" + dob + "', '" + gender
                        + "', '" + email + "', '" + marital + "', '" + address + "', '" + city + "', '" + pin + "', '"
                        + state + "')";
